...
//databsen julklappar, table "items" har kolumnerna "id", "name", "image", "link" och "descrip".
...
const routes = require('./routes/giftGen.js')
...
app.get('/', function(req, res) {
	...
	db.query('SELECT * FROM items', function(err, rows, fields) {
	  	...
	  	res.render('index.pug', {itemList: itemList, errorMessage: "Site is UP!"});
	  	}
	});
...
app.get("/gift", (req,res) => { routes.generateGift(req,res)});
app.get("/post", (req,res) => { routes.getPostPage(req,res)});
app.post("/postGift", (req,res) => { routes.postGift(req,res)});
